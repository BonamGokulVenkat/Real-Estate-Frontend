...
export default function JustForYou() {
  ...
  const { data: properties, isLoading, error } = useQuery<Property[]>({
    queryKey: ['properties', typeFilter, maxPrice[0], minBeds, sortBy],
    queryFn: async () => {
      const params: any = {};
      ...
      // We do frontend sorting for price because backend doesn't seem to have sorting integrated out of the box in the search hook.
      let sorted = [...data];
            ...
            <div className="bg-white/[0.02] backdrop-blur-3xl rounded-[32px] p-7 border border-white/10 sticky top-32 space-y-8 shadow-2xl">
              ...
              <div className="flex items-center justify-between">
                ...
                <Button 
                  ...
                  onClick={() => { setMaxPrice([100000000]); setMinBeds(0); setTypeFilter("all"); }}
                >
                  Reset
                </Button>
              </div>
