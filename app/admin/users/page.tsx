      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div>
          ...
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-white tracking-tight">
            Platform{" "}
            <span className="text-white/30 italic font-light">Users</span>
          </h1>
                      ...
                      >
                        ...
                        <td className="px-8 py-5 text-right">
                          <Button
                            ...
                            className="h-9 px-3 text-red-400 hover:text-red-300 hover:bg-red-500/10 rounded-xl transition-colors text-xs font-semibold"
                          >
      ...
      >
        <AlertDialogContent className="bg-[#0D2137] border border-white/10 text-white rounded-3xl max-w-md">
          ...
          <AlertDialogFooter className="gap-3 mt-2">
            ...
            <AlertDialogAction
              onClick={() =>
                deleteMutation.mutate(userToDelete?.user_id || userToDelete?.id)
              }
