                      ...
                      <tr key={p.property_id} className="group hover:bg-white/[0.01] transition-colors">
                        <td className="px-8 py-6">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-[10px] text-white/30 uppercase tracking-widest mt-1">{p.location?.city}</p>
                            </div>
                          </div>
                        </td>
                        <td className="px-8 py-6">
                        ...
                        <td className="px-8 py-6">
                          <div className="flex justify-end gap-3">
                            ...
                            >
                              {approveMutation.isPending ? <Loader2 className="w-3 h-3 animate-spin" /> : <><CheckCircle2 className="w-3.5 h-3.5 mr-2" /> Approve</>}
                            </Button>
                            <Button 
                              variant="destructive"
                            ...
                            >
                              {rejectMutation.isPending ? <Loader2 className="w-3 h-3 animate-spin" /> : <><XCircle className="w-3.5 h-3.5 mr-2" /> Reject</>}
                            </Button>
                          </div>
                        </td>
                      </tr>
