...
import { Search, Building2, Users, Award, Sparkles } from "lucide-react";
  ...
  return (
    <div className="min-h-screen pt-32 pb-20 bg-[#0A192F] text-white selection:bg-amber-500/30">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-20 space-y-6">
          ...
          >
            ...
            <p className="text-white/40 text-lg md:text-xl font-light leading-relaxed max-w-2xl">
              Connect with the industry&apos;s most trusted real estate experts. 
        ...
        {/* ── Search Bar (Refined Luxury Input) ── */}
        <div className="max-w-3xl mx-auto flex flex-col md:flex-row gap-4 mb-20">
          ...
          <Button className="h-16 px-10 bg-amber-500 hover:bg-amber-400 text-[#0A192F] font-bold rounded-2xl uppercase tracking-widest text-[10px] transition-all active:scale-95 shadow-lg shadow-amber-500/10">
            Search Network
          </Button>
        </div>
