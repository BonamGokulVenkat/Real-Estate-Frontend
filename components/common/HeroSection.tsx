...
export default function HeroSection() {
  ...
  const selectTriggerClass =
    "w-full border-0 bg-transparent text-white focus:ring-0 focus:ring-offset-0 shadow-none h-10 px-0 font-light justify-between";

  const selectContentClass =
    "w-[var(--radix-select-trigger-width)] min-w-[var(--radix-select-trigger-width)] bg-[#0D2137] border-white/10 text-white shadow-none";

  const selectItemClass =
    "focus:bg-amber-500/20 focus:text-amber-400 cursor-pointer";
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative bg-[#0A192F]/60 backdrop-blur-3xl border border-white/10 rounded-2xl p-2">
              <div className="flex flex-col md:flex-row items-stretch gap-2">
                {/* Country Selector */}
                <div className="flex-1 min-w-0 flex items-center gap-3 px-4 py-3 bg-white/5 border border-white/5 rounded-xl focus-within:border-amber-500/50 transition-all">
                ...
                <Separator
                  ...
                  className="hidden md:block bg-white/10 h-10 self-center"
                />
                ...
                <Button
                  ...
                  className="md:w-auto w-full h-12 md:h-auto px-8 bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold rounded-xl transition-all active:scale-95 shadow-none"
                >
                  Search
